...
public class MenuBar extends JMenuBar implements Observer {
    ...
    private JMenu mainMenu() {
        ...
        myStart.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent theEvent) {
                ...
                myScorePanel.setMyLevel(1);
                myScorePanel.setMyScore(0);
                myTimer.setDelay(A_SEC);
            }
            
        });
        myStart.setMnemonic(KeyEvent.VK_S);
        myStart.setAccelerator(KeyStroke.getKeyStroke('S',
        ...
        myPause.setAccelerator(KeyStroke.getKeyStroke('P',
                                         java.awt.event.InputEvent.CTRL_MASK));
        main.add(myPause);
        ...
        myResume.setEnabled(false);
        myResume.setMnemonic(KeyEvent.VK_R);
        myResume.setAccelerator(KeyStroke.getKeyStroke('R',
                                          java.awt.event.InputEvent.CTRL_MASK));
        main.add(myResume);
        ...
        myEnd.setAccelerator(KeyStroke.getKeyStroke('N',
                                       java.awt.event.InputEvent.CTRL_MASK));
        main.add(myEnd);
    ...
    /**
     * Get a boolean value for checking game.
